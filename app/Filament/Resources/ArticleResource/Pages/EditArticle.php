...
class EditArticle extends EditRecord
{
    ...
    /**
     * The `tags` field isn't a real column — the form needs the article's
     * current tag *names* (ArticleService::syncTags expects names, same
     * as on create) to prefill the TagsInput.
     */
